...
function projectAuthority(authority, mode) {
  if (!authority || mode !== 'routed-handoff-package') return Object.freeze({ state: 'not-supplied', route: null, handoff: null, role: null, mutationBoundary: null });
  return Object.freeze({
    ...
    mutationBoundary: authority.mutationBoundary || null
  });
}
