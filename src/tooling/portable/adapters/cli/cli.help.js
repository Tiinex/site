export function portableCliHelpText(commandPrefix = '') {
  ...
  return [
    ...
    `${command} manufacture-handoff-package <workspace-dir> --handoff <workspace-relative-handoff.trace.md> --workspace-id <id> (--output handoff.zip | --output-dir <dir>) [--handoff-routes <path1,path2,path3> --route <selected-path>] [--collision-instance 2] [--transport-text [sidecar.txt]] [--tooling-bootstrap embedded|persistent] [--tooling-bootstrap-manifest verified-bootstrap.json] [--material-bindings bindings.json] [--no-roundtrip]`,
