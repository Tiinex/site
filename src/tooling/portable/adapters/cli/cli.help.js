export function portableCliHelpText(commandPrefix = '') {
  ...
  return [
    ...
    `${command} manufacture-handoff-package <workspace-dir> --handoff <workspace-relative-handoff.trace.md> --workspace-id <id> (--output handoff.zip | --output-dir <dir>) [--additional-workspaces <id=dir,id=dir> | --workspace-roots workspaces.json] [--handoff-routes <path1,path2> | --workspace-routes routes.json] [--route <selected-path-or-route-id>] [--collision-instance 2] [--transport-text [sidecar.txt]] [--tooling-bootstrap embedded|persistent] [--tooling-bootstrap-manifest verified-bootstrap.json] [--material-bindings bindings.json] [--no-roundtrip]`,
    ...
    'Handoff human return: when ready, use humanOutput.primary as the sole package choice and render humanOutput.normalInlineRouting.content adjacent to it; --transport-text is optional fallback only.',
