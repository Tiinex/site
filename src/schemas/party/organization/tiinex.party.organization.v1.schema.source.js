...
export const schemaSource = defineBundledSchemaSource(binding, projection, Object.freeze({
  bundledPath: 'src/schemas/party/organization/tiinex.party.organization.v1.schema.md',
  sourceLabel: 'Viewer schema registry',
  assetUrl: new URL('./tiinex.party.organization.v1.schema.md', import.meta.url).href
}));
