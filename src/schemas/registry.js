...
const modules = [rootSchemaModule, workspaceSchemaModule, topicSchemaModule, taskSchemaModule, interpretationSchemaModule, relationSchemaModule, preservationSchemaModule, evidenceSchemaModule, moduleSchemaModule, surfaceSchemaModule];
