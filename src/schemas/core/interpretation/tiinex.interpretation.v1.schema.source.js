...
import projection from './tiinex.interpretation.v1.schema.runtime.json' with { type: 'json' };
...
export const schemaSource = defineBundledSchemaSource(binding, projection, Object.freeze({
  bundledPath: 'src/schemas/core/interpretation/tiinex.interpretation.v1.schema.md',
  sourceLabel: 'Viewer schema registry',
  assetUrl: new URL('./tiinex.interpretation.v1.schema.md', import.meta.url).href
}));
