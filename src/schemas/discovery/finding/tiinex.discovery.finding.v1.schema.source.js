...
import projection from './tiinex.discovery.finding.v1.schema.runtime.json' with { type: 'json' };
...
export const schemaSource = defineBundledSchemaSource(binding, projection, Object.freeze({
  bundledPath: 'src/schemas/discovery/finding/tiinex.discovery.finding.v1.schema.md',
  sourceLabel: 'Viewer schema registry',
  assetUrl: new URL('./tiinex.discovery.finding.v1.schema.md', import.meta.url).href
}));
