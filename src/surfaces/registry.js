...
const surfaces = [
  defineSurface({ id: 'feed', kind: 'card', label: 'Feed', purpose: 'Scan current artifact set', status: SurfaceImplementationStatus.partial, owner: 'workspace.feed.presenter', boundary: [SurfaceTruthBoundary.projectionOnly, SurfaceTruthBoundary.noTruthMutation], notes: ['Uses normalized workspace material; not yet full legacy Feed parity.'] }),
  defineSurface({ id: 'tree', kind: 'tree', label: 'Tree', purpose: 'Navigate declared path and continuity structure', status: SurfaceImplementationStatus.partial, owner: 'workspace.pathTree', boundary: [SurfaceTruthBoundary.projectionOnly, SurfaceTruthBoundary.noTruthMutation], notes: ['Path-tree parity is partial; declared lineage graph parity remains separate.'] }),
  ...
  defineSurface({ id: 'detail', kind: 'detail', label: 'Detail', purpose: 'Read one artifact deeply', status: SurfaceImplementationStatus.scaffold, owner: 'root.detail.presenter', boundary: [SurfaceTruthBoundary.projectionOnly, SurfaceTruthBoundary.noTruthMutation] }),
  defineSurface({ id: 'preview', kind: 'detail', label: 'Preview', purpose: 'Preview material or assets', status: SurfaceImplementationStatus.scaffold, owner: 'root.preview.presenter', boundary: [SurfaceTruthBoundary.projectionOnly, SurfaceTruthBoundary.noTruthMutation] }),
  defineSurface({ id: 'share', kind: 'card', label: 'Share', purpose: 'Summarize for session sharing/export', status: SurfaceImplementationStatus.scaffold, owner: 'root.share.presenter', boundary: [SurfaceTruthBoundary.projectionOnly, SurfaceTruthBoundary.commandRequired, SurfaceTruthBoundary.noTruthMutation] }),
  ...
  defineSurface({ id: 'display-options', kind: 'checklist', label: 'Display Options', purpose: 'Control filters and reader density', status: SurfaceImplementationStatus.scaffold, owner: 'reader.resolve', boundary: [SurfaceTruthBoundary.projectionOnly, SurfaceTruthBoundary.noTruthMutation] }),
