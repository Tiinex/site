...
assert.equal(pocParityLedger.checkpoint, 'v176', 'ledger checkpoint should match package checkpoint');
...
assert.equal(summary.checkpoint, 'v176', 'summary checkpoint matches ledger');
