...
assert.equal(pocParityLedger.checkpoint, 'v172', 'ledger checkpoint should match package checkpoint');
...
assert.equal(summary.checkpoint, 'v172', 'summary checkpoint matches ledger');
