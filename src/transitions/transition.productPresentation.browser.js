import { transitionProductActionsForRecord as transitionProductActionsForRecordPure, transitionProductActionsForWorkspace as transitionProductActionsForWorkspacePure, transitionProductContextForWorkspace as transitionProductContextForWorkspacePure, isCanonicalTransitionProductAction, CANONICAL_TRANSITION_PRODUCT_ACTION_KIND, LEGACY_CANONICAL_PRESENTATION_COMPATIBILITY } from './transition.productPresentation.js';
...
export function transitionProductActionsForWorkspace(options = {}) {
  return transitionProductActionsForWorkspacePure({
    ...options,
    schemaCache: options.schemaCache || BUNDLED_CANONICAL_TRANSITION_SCHEMA_CACHE,
    bundledDefinitions: options.bundledDefinitions || BUNDLED_CANONICAL_TRANSITION_DEFINITIONS
  });
...
export function transitionProductContextForWorkspace(options = {}) {
  return transitionProductContextForWorkspacePure({
    ...options,
    schemaCache: options.schemaCache || BUNDLED_CANONICAL_TRANSITION_SCHEMA_CACHE,
    bundledDefinitions: options.bundledDefinitions || BUNDLED_CANONICAL_TRANSITION_DEFINITIONS
  });
