...
return { id: 'local', kind: 'local', adapterId: 'local', sourceKind: 'local.session', label: 'Local', count: Number(input.count || 0), config: { persistence: 'browser-local' }, boundary: 'browser-local session material', closeable: false };
}
