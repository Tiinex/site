...
import { playthingsLineageNodesNewestFirst, playthingsLineageSnapshotFor } from './playthings.lineage.js';
...
assert.deepEqual(playthingsLineageNodesNewestFirst(snapshot.selectedTraversal).map((node) => node.id), ['child-record', 'root-record'], 'Playthings Lineage Verse keeps latest/current at the top and lets Parent fall downward to oldest/root');
