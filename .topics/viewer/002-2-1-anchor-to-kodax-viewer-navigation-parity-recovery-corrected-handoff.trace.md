...
- Parent
  ...
  - Trace: [002-2-anchor-to-kodax-viewer-navigation-parity-recovery-handoff.trace.md](002-2-anchor-to-kodax-viewer-navigation-parity-recovery-handoff.trace.md)
  - Origin:
    - [relative](002-2-anchor-to-kodax-viewer-navigation-parity-recovery-handoff.trace.md)
- Current
  - Current Schema: [tiinex.handoff.v1](https://github.com/Tiinex/docs/blob/3988951208eb9a8926e84ab42625d4b42fa00c2d/.topics/.schemas/coordination/handoff/tiinex.handoff.v1.schema.md)
  - Created At: 2026-09-03 14:11:43
  - Authors: Anchor
  - Why: Canonical Handoff manufacture correctly rejected a workspace-wide Required Context declaration without an exact material reference; preserve the same transfer while separating semantic required material from transport-carried source.
  - Summary: Correct the Kodax transfer so exact task/role/discovery artifacts are Required Context while the full source workspace remains carried implementation material rather than semantic required-context proof.
  - Status: ready/local
...
- carried-full-source-workspace
  - Material: current full-source Site workspace carried by canonical Handoff manufacture
  - Purpose: implementation substrate for the bounded task; transport presence does not make every workspace file semantic Required Context or authority
  - Availability: available
...
- [sha256-base64url-c14n-v2](https://github.com/Tiinex/docs/blob/3988951208eb9a8926e84ab42625d4b42fa00c2d/.topics/.validators/sha256-base64url-c14n-v2.validator.md)
  - Towards: [002-2-anchor-to-kodax-viewer-navigation-parity-recovery-handoff.trace.md](002-2-anchor-to-kodax-viewer-navigation-parity-recovery-handoff.trace.md)
