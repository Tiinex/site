...
- Current
  ...
  - Why: Provide the final fresh-Anchor route after correcting the recording transport state so the carrier remains bounded and honest.
  - Summary: Transfer the reverted current Playthings baseline, recovered rejected lineage, Sigma rejection evidence, and bounded recording review material to a fresh Anchor.
  - Status: ready/local
...
- sigma-regression-evidence
  - Material: Sigma end-user regression/revert Evidence plus bounded recording transport receipt and derived visual review sheets
  - Material Reference: [Regression Evidence](003-1-sigma-playthings-end-user-regression-rejection-and-revert-evidence.trace.md)
  - Purpose: establishes why the previous acceptance candidate is NOT PASS and why the reverted source is authoritative for continuation; the exact source-video identity is retained by SHA-256 while bounded visual derivatives are carried
  - Availability: available
...
- acceptance-recording-transport-receipt
  - Material: qualified Evidence correcting the earlier transport-preservation claim and recording the exact source-video SHA-256 plus carried visual derivatives
  - Material Reference: [Recording Transport Receipt](003-1-2-fresh-anchor-acceptance-recording-transport-receipt-evidence.trace.md)
  - Purpose: lets the fresh Anchor inspect representative failure frames without requiring the approximately 300 MiB source MP4 inside the carrier
  - Availability: available

- acceptance-regression-contact
  - Material: derived frame contact sheet from Sigma's source recording
  - Material Reference: [Regression Contact Sheet](../../reference/playthings/acceptance/2026-09-05/sigma-playthings-regression-contact.jpg)
  - Purpose: bounded direct visual orientation for package/Viewer regression review
  - Availability: available

- acceptance-world-sequence
  - Material: derived Playthings-world frame sequence from Sigma's source recording
  - Material Reference: [World Regression Sequence](../../reference/playthings/acceptance/2026-09-05/sigma-playthings-world-regression-sequence.jpg)
  - Purpose: bounded direct visual orientation for the regressed Playthings experience
  - Availability: available
...
- source-recording-bytes
  - Kind: excluded-scope
  - Description: the approximately 300 MiB source MP4 is not embedded in this carrier; its exact SHA-256 and media identity are preserved in the recording transport receipt, and two derived review sheets are carried
