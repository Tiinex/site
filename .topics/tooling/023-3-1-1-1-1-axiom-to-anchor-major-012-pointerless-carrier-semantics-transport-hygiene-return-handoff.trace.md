...
- Current
  ...
  - Created At: 2026-09-06 14:49:53
  - Authors: Axiom
  - Why: Repair Handoff transport hygiene only so Anchor can resolve recipient role identity explicitly without changing the accepted semantic disposition.
  - Summary: Re-emit the qualified Axiom two-mode Handoff Package disposition with explicit durable Axiom and Anchor Role endpoint references.
  - Status: ready/local
...
- [sha256-base64url-c14n-v2](https://github.com/Tiinex/docs/blob/3988951208eb9a8926e84ab42625d4b42fa00c2d/.topics/.validators/sha256-base64url-c14n-v2.validator.md)
  - Towards: self
  - Value: sR_prVlTjkIQRTJAHlaX9NFM6C8NGG0AAh0KSR8jygw