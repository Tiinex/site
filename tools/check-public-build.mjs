...
try {
  ...
  for (const needle of [
    'react-v119', 'UC-001-empty-create-local-workspace', 'No nodes match this view', 'Workspace name is required',
  ...
  if (!String(identity.source || '').includes('v119')) fail('Public build identity should disclose v119 source shell');
  if (failures.length) {
