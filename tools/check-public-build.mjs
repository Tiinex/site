...
try {
  ...
  for (const needle of [
    'react-v174-presentation-display-truth', 'UC-001-empty-create-local-workspace', 'No nodes match this view', 'Workspace name is required',
  ...
  if (!String(identity.source || '').includes('v174')) fail('Public build identity should disclose v174 source shell');
  if (failures.length) {
