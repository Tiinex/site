...
try {
  ...
  for (const needle of [
    'react-v173-presentation-display-truth', 'UC-001-empty-create-local-workspace', 'No nodes match this view', 'Workspace name is required',
  ...
  if (!String(identity.source || '').includes('v173')) fail('Public build identity should disclose v173 source shell');
  if (failures.length) {
