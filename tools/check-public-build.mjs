...
if (!main.includes('tx-shell-pattern-parity')) fail('Fresh public runtime must render v102 pattern parity shell');
if (!main.includes('tx-shell-legibility-corrected')) fail('Fresh public runtime must render v102 legibility-corrected shell');
...
if (!main.includes('tx-shell-column-fit')) fail('Fresh public runtime must render v102 Column fit shell');
if (!main.includes('tx-shell-icon-polish')) fail('Fresh public runtime must render v102 icon polish shell');
if (!main.includes("activePane: 'site'")) fail('Fresh public runtime must default to the Tiinex/site pane');
if (!main.includes('v102 scroll ownership')) fail('Fresh public runtime must disclose v102 scroll ownership scope');
