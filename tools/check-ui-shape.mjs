...
has(main, 'tx-dock-left', 'multiverse control must live directly left of logo');
has(main, 'tx-dock-right', 'create/share/help controls must live right of logo');
...
has(css, 'grid-template-columns: minmax(40px, 1fr) 44px minmax(40px, 1fr)', 'dock center grid contract missing');
